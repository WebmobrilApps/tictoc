...
class DummyFor extends StatefulWidget {
  final String fromPage;
  const DummyFor({super.key, required this.fromPage});

  @override
  State<DummyFor> createState() => _DummyForState();
}

class _DummyForState extends State<DummyFor> {
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      largeText16(context, 'Dummy Verification', fontSize: 20,

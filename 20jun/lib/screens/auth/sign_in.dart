            ...
            if (state.status == TicTocStatus.signInSuccess){
              ...
              if(signInResponse.data?.user?.isVerify != 1){
                ...
                CustomNavigator.pushAndRemoveUntil(context: context,
                    screen: Interest(tmpToken: signInResponse.data?.token??'',
                        ...
                        myFirebaseId:signInResponse.data?.user?.firebaseId??'',
                    ),
                ...
                PreferenceManager.insertValue(key: FIREBASE_ID, value: signInResponse.data?.user?.firebaseId.toString());
              ...
              if(guestLoginResponse.interest==false){
                 CustomNavigator.pushAndRemoveUntil(context: context, screen: Interest(
                     tmpToken: guestLoginResponse.token??'',

...
class Interest extends StatefulWidget {
  ...
  const Interest({super.key, required this.tmpToken,required this.userID, required this.myFirebaseId});
          ...
          listener: (context,state){
            if (state.status == TicTocStatus.userInterestSuccess){
             // UiHelper.toastMessage(state.responseData?.response ?? '');
              ...
              PreferenceManager.insertValue(key: FIREBASE_ID, value: widget.myFirebaseId);

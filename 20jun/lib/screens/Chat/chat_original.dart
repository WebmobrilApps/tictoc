                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        mediumText14(context, "Pushkar Saraswat"),
                        mediumText14(context, "121",textColor: const Color(0xff484848)),
                        UiHelper.verticalSpace(height: 6),
                        Row( mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            mediumText14(context, '@${"123"} following',textColor: const Color(0xff484848)),
                            mediumText14(context, '@${"413"} followers',textColor: const Color(0xff484848)),
                          ],
                        ),
